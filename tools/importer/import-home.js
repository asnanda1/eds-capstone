...
const PAGE_TEMPLATE = {
  ...
  sections: [
    ...
    {
      id: 's3', name: 'Recent articles', selector: ['.cmp-layout-container--fixed:nth-of-type(1)'], style: null, blocks: ['cards-article'], defaultContent: ['.title.cmp-title--underline', '.button'],
    },
    {
      id: 's4', name: 'Next adventures feature', selector: ['.teaser.cmp-teaser--hero.cmp-teaser--imagebottom'], style: null, blocks: ['hero-feature'], defaultContent: ['.title.cmp-title--underline'],
    },
    {
      id: 's5', name: 'Where do you want to go', selector: ['.cmp-layout-container--fixed:nth-of-type(2)'], style: null, blocks: ['cards-article'], defaultContent: ['.title', '.button'],
    },
  ],
};
